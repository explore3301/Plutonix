      ...
      color = client.main
        ...
        const row1 = new MessageActionRow().addComponents(
            new MessageButton()
                .setStyle("SECONDARY")
                .setLabel("Yes")
                .setEmoji(`<:nutt_tikk:1073143424116605049>`)
                .setCustomId("y"),

            new MessageButton()
                .setStyle("SECONDARY")
                .setLabel("No")
                .setEmoji(`<:nutt_crss:1073143518211616808>`)
                .setCustomId("n"),
        ...
        const row2 = new MessageActionRow().addComponents(
            new MessageButton()
                .setStyle("SECONDARY")
                .setLabel("Probably")
                .setEmoji(`<:Pro_yes:1077629894269349959>`)
                .setCustomId("pb"),

            new MessageButton()
                .setStyle("SECONDARY")
                .setLabel("Probaby Not")
                .setEmoji(`<:no:1077630195927879691>`)
                .setCustomId("pn"),

            new MessageButton()
                .setStyle("DANGER")
                .setLabel("Stop")
                .setEmoji(`<:nutt_btn:1073206535628533841>`)
                .setCustomId("stop"),
        )
