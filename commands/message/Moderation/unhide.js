...
module.exports = {
 ...
 if (!message.member.permissions.has('MANAGE_CHANNELS')){
    ...
    .setImage(`https://media.discordapp.net/attachments/1079006328648896635/1079077262005112904/20230225_214034.jpg`)
      .setColor(color)
      return message.channel.send({embeds: [emb]})
    } 
  else {
      const embi = new MessageEmbed()
        .setDescription(`<:nutt_crss:1073143518211616808> | I don't have adequate permissions to hide this channel.`)
        .setColor(color)
