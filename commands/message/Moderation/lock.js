  ...
  run: async (client, message, args, prefix) => {
   ...
   color = client.main
    ...
    const emb = new MessageEmbed()
      .setDescription(`${channel} has been locked from @everyone role.`)
    .setImage(`https://media.discordapp.net/attachments/1079006328648896635/1079066689360121946/20230225_211440.jpg`)
      .setColor(color)
