...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    try{
      ...
      message.reply({embeds: [new MessageEmbed().setColor(client.color).setDescription(`<:nutt_tikk:1073143424116605049> | Successfully Kicked <@${member.user.id}> From Voice!`)]});
    }catch(err){
